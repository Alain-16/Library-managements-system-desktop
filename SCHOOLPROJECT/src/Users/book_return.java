...
public class book_return {
    ...
    public book_return(int id, String name, String depart, String bkclass, Date mydate, Date returndate, String status, int stuid, String stu_name, String stu_class, String special) {
        this.bookid = id;
        this.bookname = name;
        this.depart = depart;
